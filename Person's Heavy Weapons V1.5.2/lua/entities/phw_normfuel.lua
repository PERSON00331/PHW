...
if SERVER then
    util.AddNetworkString("PHWNormalFuel_FireStart")
    util.AddNetworkString("PHWNormalFuel_FireStop")
    util.AddNetworkString("PHWNormalFuel_Explode")
    util.AddNetworkString("PHWNormalFuel_FizzParticles")
    ...
    function ENT:StartExplosionCountdown()
        ...
        net.Start("PHWNormalFuel_FireStart")
            net.WriteEntity(self)
        net.Broadcast()
    end

    function ENT:StartFizzSequence()
        net.Start("PHWNormalFuel_FizzParticles")
            net.WriteEntity(self)
        net.Broadcast()
    ...
    function ENT:Explode()
        ...
        net.Start("PHWNormalFuel_Explode")
            net.WriteVector(pos)
        net.Broadcast()

        net.Start("PHWNormalFuel_FireStop")
            net.WriteEntity(self)
        net.Broadcast()
...
if CLIENT then
    ...
    net.Receive("PHWNormalFuel_FireStart", function()
    ...
    net.Receive("PHWNormalFuel_FireStop", function()
        local ent = net.ReadEntity()
    ...
    net.Receive("PHWNormalFuel_Explode", function()
    ...
    net.Receive("PHWNormalFuel_FizzParticles", function()
        local ent = net.ReadEntity()
        if not IsValid(ent) then return end

        local idx = ent:EntIndex()
        local emitter = ParticleEmitter(ent:GetPos())
        local timerID = "PHWNormalFuelFizz_" .. idx
    ...
    hook.Add("Think", "PHWNormalFuel_FireParticles", function()
