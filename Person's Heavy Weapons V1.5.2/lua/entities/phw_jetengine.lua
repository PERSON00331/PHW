...
ENT.PrintName   = "Big Jet Engine"
ENT.Author      = "Person"
ENT.Spawnable   = true
ENT.Category    = "P.H.W"

if SERVER then
    util.AddNetworkString("PHW_JetFX")

    function ENT:Initialize()
        self:SetModel("models/xqm/jetenginebig.mdl")
        ...
        self.ThrustForce   = 0
        self.MaxThrust     = 657000
        self.ThrustGain    = 6555
...
if CLIENT then
    net.Receive("PHW_JetFX", function()
